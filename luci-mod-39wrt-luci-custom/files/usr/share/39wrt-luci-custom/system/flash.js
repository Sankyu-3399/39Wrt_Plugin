...
const mapdata = { actions: {}, config: {}, firmware_cloud: {} };
...
return view.extend({
	...
	render([p_fstat, hostname, procmtd, procpart, procmounts]) {
		...
		s = m.section(form.NamedSection, 'firmware_cloud', 'firmware_cloud', _('固件网盘'));

		o = s.option(form.DummyValue, '_firmware_cloud');
		o.renderWidget = function(section_id, option_index, cfgvalue) {
			return E('iframe', {
				'src': 'http://pan.39network.cc:5212/s/gLtJ',
				'style': 'display:block;width:100%;height:calc(100vh - 260px);min-height:640px;border:0;background:#fff;',
				'loading': 'lazy',
